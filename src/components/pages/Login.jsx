            ...
            <div className="row gx-lg-5 align-items-center mb-5">
              <div className="col-lg-6 mb-5 mb-lg-0" style={{ zIndex: "10" }}>
                ...
                >
                  ...
                  can choose whether or not they'd like to be contacted about
                  one of our products. This allows the reader to feel like they
                  are receiving valuable information without being forced to
                    ...
                    <form onSubmit={handleSubmit}>
                      {Object.keys(errors).length === 0 && isSubmit ? (
                        ...
                        <div className="alert alert-info" role="alert">
                          Please enter required details to Sign in !!
                        </div>
                      )}
