    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-light border border-info rounded">
                ...
                <button style={{marginRight:"5"}} class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                        Menu
                    </button>

                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                        <div class="offcanvas-header">
                            <h5 class="offcanvas-title" id="offcanvasExampleLabel">AdminAccess</h5>
